const theme = {
  ...
  typography: {
      ...
      css: [
        {
          ...
          'ol[type="a"]': { "--list-counter-style": "lower-alpha" },
          'ol[type="A s"]': { "--list-counter-style": "upper-alpha" },
          'ol[type="a s"]': { "--list-counter-style": "lower-alpha" },
          'ol[type="I"]': { "--list-counter-style": "upper-roman" },
          'ol[type="i"]': { "--list-counter-style": "lower-roman" },
          'ol[type="I s"]': { "--list-counter-style": "upper-roman" },
          'ol[type="i s"]': { "--list-counter-style": "lower-roman" },
          'ol[type="1"]': { "--list-counter-style": "decimal" },
          ...
          hr: { borderColor: "#e4e4e7", borderTopWidth: 1 },
          blockquote: {
            fontWeight: "500",
            fontStyle: "italic",
            color: "#18181b",
          ...
          h1: { color: "#18181b", fontWeight: "800" },
          h2: { color: "#18181b", fontWeight: "700" },
          h3: { color: "#18181b", fontWeight: "600" },
          h4: { color: "#18181b", fontWeight: "600" },
          "figure figcaption": { color: "#71717a" },
          code: { color: "#18181b", fontWeight: "600" },
          "code::before": { content: '"`"' },
          "code::after": { content: '"`"' },
          "a code": { color: "#18181b" },
          pre: {
        ...
        },
        {
          ...
          "ol > li": { paddingLeft: "1.75em" },
          "ol > li::before": { left: "0" },
          "ul > li": { paddingLeft: "1.75em" },
          "ul > li::before": {
            width: "0.375em",
            height: "0.375em",
      ...
      css: [
        {
          ...
          ol: { marginTop: "1.1428571em", marginBottom: "1.1428571em" },
          ul: { marginTop: "1.1428571em", marginBottom: "1.1428571em" },
          li: { marginTop: "0.2857143em", marginBottom: "0.2857143em" },
          "ol > li": { paddingLeft: "1.5714286em" },
          "ol > li::before": { left: "0" },
          "ul > li": { paddingLeft: "1.5714286em" },
          "ul > li::before": {
            height: "0.3571429em",
            width: "0.3571429em",
      ...
      css: [
        {
          ...
          ol: { marginTop: "1.3333333em", marginBottom: "1.3333333em" },
          ul: { marginTop: "1.3333333em", marginBottom: "1.3333333em" },
          li: { marginTop: "0.6666667em", marginBottom: "0.6666667em" },
          "ol > li": { paddingLeft: "1.6666667em" },
          "ol > li::before": { left: "0" },
          "ul > li": { paddingLeft: "1.6666667em" },
          "ul > li::before": {
            width: "0.3333333em",
            height: "0.3333333em",
      ...
      css: [
        {
          ...
          "ol > li": { paddingLeft: "1.8em" },
          "ol > li::before": { left: "0" },
          "ul > li": { paddingLeft: "1.8em" },
          "ul > li::before": {
            width: "0.35em",
            height: "0.35em",
    ...
    rose: {
      css: [{ a: { color: "#df113d" }, "a code": { color: "#df113d" } }],
    },
    pink: {
      css: [{ a: { color: "#da1b6e" }, "a code": { color: "#da1b6e" } }],
    },
    fuchsia: {
      css: [{ a: { color: "#c419d7" }, "a code": { color: "#c419d7" } }],
    },
    purple: {
      css: [{ a: { color: "#9c3eef" }, "a code": { color: "#9c3eef" } }],
    },
    violet: {
      css: [{ a: { color: "#8151f0" }, "a code": { color: "#8151f0" } }],
    },
    indigo: {
      css: [{ a: { color: "#5158e6" }, "a code": { color: "#5158e6" } }],
    },
    blue: {
      css: [{ a: { color: "#2262ec" }, "a code": { color: "#2262ec" } }],
    },
    lightBlue: {
      css: [{ a: { color: "#0284c7" }, "a code": { color: "#0284c7" } }],
    },
    cyan: {
      css: [{ a: { color: "#0b84a2" }, "a code": { color: "#0b84a2" } }],
    },
    teal: {
      css: [{ a: { color: "#0c8375" }, "a code": { color: "#0c8375" } }],
    },
    emerald: {
      css: [{ a: { color: "#0b845c" }, "a code": { color: "#0b845c" } }],
    },
    green: {
      css: [{ a: { color: "#198641" }, "a code": { color: "#198641" } }],
    },
    lime: {
      css: [{ a: { color: "#568712" }, "a code": { color: "#568712" } }],
    },
    yellow: {
      css: [{ a: { color: "#a3690a" }, "a code": { color: "#a3690a" } }],
    },
    amber: {
      css: [{ a: { color: "#ae5f0a" }, "a code": { color: "#ae5f0a" } }],
    },
    orange: {
      css: [{ a: { color: "#ea580c" }, "a code": { color: "#ea580c" } }],
    },
    red: { css: [{ a: { color: "#e11919" }, "a code": { color: "#e11919" } }] },
    warmGray: {
      css: [{ a: { color: "#57534e" }, "a code": { color: "#57534e" } }],
    },
    trueGray: {
      css: [{ a: { color: "#525252" }, "a code": { color: "#525252" } }],
    },
    coolGray: {
      css: [{ a: { color: "#4b5563" }, "a code": { color: "#4b5563" } }],
    },
    blueGray: {
      css: [{ a: { color: "#475569" }, "a code": { color: "#475569" } }],
    },
    gblue: {
      css: [{ a: { color: "#3970d0" }, "a code": { color: "#3970d0" } }],
    },
    "light-blue": {
      css: [{ a: { color: "#0d78ba" }, "a code": { color: "#0d78ba" } }],
    },
    gt: { css: [{ a: { color: "#198641" }, "a code": { color: "#198641" } }] },
  },
  screens: {
    sm: "640px",
    md: "768px",
